...
function App() {
  ...
  const [activeBedsKey, setActiveBedsKey] = useState("All");
  const [activeFurnishedKey, setActiveFurnishedKey] = useState("All");
    ...
    <div className="App" >
      ...
      <div className=' d-flex justify-content-center flex-wrap'>
        <Navbar className='filterNav'>
          ...
          <Nav variant="pills" defaultActiveKey="All" activeKey={priceType} onSelect={selectPriceFilterType}>
        ...
        <Navbar className='filterNav'>
          ...
          <Nav variant="pills" defaultActiveKey="All" activeKey={furnishedType} onSelect={selectFurnishedFilterType}>
                <Nav.Item><Nav.Link eventKey="All">All</Nav.Link></Nav.Item>
        ...
        <Navbar className='filterNav'>
          ...
          <Nav variant="pills" defaultActiveKey="All" activeKey={bedType} onSelect={selectBedFilterType}>
                <Nav.Item><Nav.Link eventKey="All">All</Nav.Link></Nav.Item>
